  ...
  <div class="min-h-screen bg-slate-50">
    ...
    <main class="max-w-4xl mx-auto px-4 py-8">
      <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6 mb-8">
        <label for="phone" class="block text-sm font-medium text-slate-700 mb-3">
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  <div class="text-xl font-semibold text-slate-900">{{ results.zhuGua.top.bagua }}</div>
                  <div class="text-sm text-slate-600">{{ results.zhuGua.top.element }}</div>
                  <div class="text-xs text-slate-500 mt-1">
                    Sum: {{ results.zhuGua.top.sumOfDigits }} | Mod: {{ results.zhuGua.top.mod }}
                  </div>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  <div class="text-xl font-semibold text-slate-900">{{ results.zhuGua.bottom.bagua }}</div>
                  <div class="text-sm text-slate-600">{{ results.zhuGua.bottom.element }}</div>
                  <div class="text-xs text-slate-500 mt-1">
                    Sum: {{ results.zhuGua.bottom.sumOfDigits }} | Mod: {{ results.zhuGua.bottom.mod }}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  <div class="text-xl font-semibold text-slate-900">{{ results.huGua.top.bagua }}</div>
                  <div class="text-sm text-slate-600">{{ results.huGua.top.element }}</div>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  <div class="text-xl font-semibold text-slate-900">{{ results.huGua.bottom.bagua }}</div>
                  <div class="text-sm text-slate-600">{{ results.huGua.bottom.element }}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div class="flex items-center gap-4">
                ...
                <div>
                  <div class="text-xl font-semibold text-slate-900">{{ results.ziGua.top.bagua }}</div>
                  <div class="text-sm text-slate-600">{{ results.ziGua.top.element }}</div>
                </div>
              </div>
            </div>
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
